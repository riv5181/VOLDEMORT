class adminSettings:
    ...
    tcpThreshold = 60 # percentage with other thresholds; total with other thresholds should be 100
    udpThreshold = 25 # percentage with other thresholds; total with other thresholds should be 100
    icmpThreshold = 15 # percentage with other thresholds; total with other thresholds should be 100
    ...
    tcplimit = 40 #Minimum possible threshold for TCP; Calculated values may never go beyond the given number
    udplimit = 15 #Minimum possible threshold for UDP; Calculated values may never go beyond the given number
    icmplimit = 10 #Minimum possible threshold for ICMP; Calculated values may never go beyond the given number
